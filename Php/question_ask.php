...
?>
<form action="question_ask.php" method="POST">
<center><textarea name="question" rows="5" cols="70"></textarea></center><br><br>
<br><br><input type="submit" value="Ask it!" name="submit">
