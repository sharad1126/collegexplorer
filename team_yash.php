...
<body class="loaded">
    ...
    <header class="hero-banner img_loaded" style="margin-top: 60px;">
        <img class="resize" src="assets/images/yash_lg.jpg" style="transition-property: all; transition-duration: 0s; transition-timing-function: ease; opacity: 1;">
        <hgroup>
            <h1>Yash Jain</h1>
            <h2 class="text-hl">Back End Developer</h2>
        </hgroup>
    </header>
        ...
        <div class="container-fluid" style="height:250px;">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <form id="footerSignupForm" method="POST" action="team_yash.php">
